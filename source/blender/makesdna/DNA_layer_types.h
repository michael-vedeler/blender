...
enum eViewLayerCryptomatteFlags {
  ...
  VIEW_LAYER_CRYPTOMATTE_OBJ_INDIRECT_CONTRIB = (1 << 4),
};
ENUM_OPERATORS(eViewLayerCryptomatteFlags)
#define VIEW_LAYER_CRYPTOMATTE_ALL \
  (VIEW_LAYER_CRYPTOMATTE_OBJECT | VIEW_LAYER_CRYPTOMATTE_MATERIAL | VIEW_LAYER_CRYPTOMATTE_ASSET | VIEW_LAYER_CRYPTOMATTE_OBJ_INDIRECT_CONTRIB)
